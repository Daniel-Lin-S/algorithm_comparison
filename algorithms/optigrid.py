...
from algorithms.grid_level import GridLevel
...
class Optigrid:
    ...
    def __init__(self, d, q, max_cut_score, noise_level, kde_bandwidth = None, kde_grid_ticks=100, kde_num_samples=15000, kde_atol=1E-6, kde_rtol=1E-4, verbose=False, ignore=False):
        """ 
        Parameters:
            d (int): Dimension of the data
            q (int): Number of cutting planes per iteration
            max_cut_score (double): Maximum density of a cutting plane
            noise_level: float, threshold for density of a cell to be treated as noise
            kde_bandwidth: float, bandwidth of the kernel density estimator used
            kde_grid_ticks: number of grids in each dimension, default 100
            verbose: bool, if true, print clusters found along the way, default False
        """
