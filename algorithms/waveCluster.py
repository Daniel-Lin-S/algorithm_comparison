...
def waveCluster(data,scale=50,wavelet='db2',threshold=0.5,plot=False):
    """
    The main function for wavecluster

    :param data: 2d numpy array, each row represents a data point
    :param scale: 
    :param wavelet: str, the wavelet used for clustering, default db2
        one of db1, db2, bior1.3 
    :param threshold: float, noise threshold, 0 means not filter noise, default 0.5
    :param plot: bool, whether plot the clustering result or not, default False

    :return tags: list of cluster labels
    """
